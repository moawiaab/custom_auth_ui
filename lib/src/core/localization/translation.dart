class TranslationData {
  Map<String, String> get keysAr => {
        ...
        "37": "تهانينا",
        "38": "تم التسجيل بنجاح",
        "39": "دخل البريد الالكتروني لتغير كلمة السر",
        "40": "بعد ادخال بريدك تجد رابط تغير كلمة المرور في البريد المسجل"
      };
  ...
  Map<String, String> get keysEn => {
        ...
        "39": "Enter your email to change your password",
        "40":
            "After entering your email, you will find a link to change your password in your registered email"
      };
}
